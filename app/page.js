...
import { Calendar, Car, ChevronLeft, ChevronRight, Shield } from "lucide-react";
...
export default function Home() {
  return (
    <div className="pt-20 flex flex-col">
      {/* hero */}
      <section className="realtive py-16 md:py-28 dotted-background">
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-blue-700 bg-blue-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                ...
                >
                  <div className="overflow-hidden rounded-lg flex justify-end h-28 mb-4 relative">
                    <Image
                      ...
                      alt={type.name}
                      fill
                      className="object-cover gorup-hover:scale-105 transition duration-300"
                    />
                  </div>
      ...
      <section className="py-16 dotted-background text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-3xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers who found thier perfect
