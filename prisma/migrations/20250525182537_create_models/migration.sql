...
-- CreateEnum
CREATE TYPE "DayOfWeek" AS ENUM ('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FIRDAY', 'SATURDAY', 'SUNDAY');
...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'AutoFind Motors',
    "address" TEXT NOT NULL DEFAULT '69 Car Street, Autovilla, CA 69420',
    "phone" TEXT NOT NULL DEFAULT '+1 (555) 123-3456-44',
    "email" TEXT NOT NULL DEFAULT 'contact@autofind.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
